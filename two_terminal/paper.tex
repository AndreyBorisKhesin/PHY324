...
\papersec{Introduction}
	...
	Additionally, I vs. V graphs of several capacitors, inductors, and a potentiometer were obtained. The same circuit as in \figCircuit was used, resulting in the following setup.
	
	\paperfig{SetupAdditional}{\pdf{setup_additional}\vspace{-1.5em}}{Experimental setup used to determine I vs. V curves of additional circuit components, with a \( 100 \si{\kilo\ohm} \) connected here.}
