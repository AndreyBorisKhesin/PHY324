...
\papersec{Observations}
	...
	\paperfig{SmallHemisphereFlatScreen}{\begin{papertable}{|[outer]I|[inner]C|[inner]C|[inner]C|[outer]}
			\paperoline\papertableindexheader&\textsc{Screen position}&\textsc{Lens position}&\multirow{2}{*}{\textsc{\( \Delta d \)}}\\
			\papertablecheaderunit{.05 cm}{\hspace{-0.5ex}}\papertablecheaderunit{.05 cm}{\hspace{-0.5ex}}&\\\paperiline
			\papertableindex\papertablecval{36.15}\papertablecval{29.50}\papertablecval{7.48}\\\paperiline
...
\papersec{Analysis} 
	...
	\papereq{HemisphereFlatScreen}{\Delta d'_{hemisphere} = 2\frac{R}{n\pars{n-1}}.}{}
	...
	\papereq{nValueWithSphere}{n= 2 \frac{\Delta d_{sphere}}{\Delta d'_{hemisphere}}}{}
	...
	\papereq{nHemisphereOnly}{n = \frac{\Delta d_{hemisphere}}{\Delta d'_{hemisphere}}}{}
