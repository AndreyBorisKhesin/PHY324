...
\usetikzlibrary{arrows, chains, matrix, optics, positioning, shapes}
...
%Sources
\newsavebox{\sourcebox}
\newcommand{\papersource}[1]{\bgroup
\vspace{-2em}
\text{}\\*
...
\cr{\fontsize{9pt}{9pt}\selectfont\textit{\ifx\\#3\\~\else(#3)\fi}}
\end{array}$}
\end{equation*}
...
{&$#1$ & #2 \ifx\\#3\\~\else($\smash{\text{\si{#3}}}$)\fi\\}
