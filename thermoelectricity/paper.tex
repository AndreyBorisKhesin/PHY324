...
The thermal conductance between the output heat sink and the ambient, $K_{hs}$, air was found to be $(7.1\pm.9)\si{\watt\per\kelvin}$.
	...
	By examining the derivative of $P_{in}$ with an output temperature of $\SI{35}{\celsius}$ and an input temperature not exceeding $\SI{5}{\celsius}$, the optimum input current was determined using the TEC model. It is known that $P_{in}$ obeys the following relation.
