...
\papersec{Introduction}
	...
	Further, using  \( R = k'T \), (with \( k' \) being a constant of proportionality) it was shown that
	
	\papereq{temperature}{ T = \frac{1}{k'} \frac{V}{I} =  \frac{k}{k'} I^{(a-1)}.}{}
	
	Finally, combining the above expressions and setting constants to be equal, the following relationship for \( n \) in terms of \( a \) was obtained.
	
	\papereq{temperature}{ n = \frac{a+1}{a-1} }{}
		
\papersec{Observations}

	The resistance of the thermistor at various temperatures was measured and recorded. The uncertainty, as specified by the manufacturer, was $ \pm (0.2\% + 1 $ LSD) for resistances in the $ (2 \si{\kilo\ohm}, 200 \si{\kilo\ohm}) $ range. The reading error of the thermometer was taken to be $ \pm 0.5 \si{\kelvin} $. \vspace{0.5em}
	...
	\paperfig{light-bulb}{\begin{papertable}{|[outer]I|[inner]U|[inner]U|[outer]}
			...
			\end{papertable}\vspace{-1.5em}}
	{Potential and current through the incandescent bulb.} %  \vspace{1em}
...
\papersec{Analysis}
	...
	\paperfig{thermistor-plot}{\pdf{Thermistor}}{Resistance and residuals plotted against the temperature in the thermal flask, with least squares fit included in blue. Error bars on both temperature and resistance were too small to be visible.} \vspace{1em}

	A visualization of residuals clearly indicated that the data can be better modelled for greater temperatures. Indeed, least squares fitting performed without the data points corresponding to three lowest temperatures yielded a reduced \( \chi ^ 2 \) value of \( 181.5543 \). Removing more lower-temperature data points further improved reduced \( \chi ^ 2 \). % Removing the six lower-temperature points led to a model with reduced \( \chi ^ 2 \) value of \( 130.1026 \). 
	...
	\paperfig{bulb-plot}{\pdf{Bulb}}{Potential of the incandescent light bulb plotted against the current. Least squares fit was indicated in blue; residuals visualized at the bottom. Error bars on the data points were too small to be visible.} \vspace{1em}
