...
\papersec{Introduction}
	...
	Using the expression in (3) and assuming thermal equilibrium, \( \kappa \) and \( T \) were expressed in terms of \( I \) and \( V \). Additionally, by expressing \( V \) in terms of \( I \) as shown in (2), \( \kappa \) was written in terms of \( I \) and constants only.
...
\papersec{Observations}
	...
	The resistance of the thermistor at various temperatures was measured. The uncertainty, as specified by the manufacturer, was $ \pm (.2\% + 1 $ LSD) for resistances in the $ (2 \si{\kilo\ohm}, 200 \si{\kilo\ohm}) $ range. The reading error of the thermometer was taken to be $ \pm .5 \si{\kelvin} $. \vspace{0.5em}
	...
	\paperfig{thermistor}{\begin{papertable}{|[outer]I|[inner]C|[inner]U|[outer]}
			...
			\papertablecheadersymbol{T$ $(\pm.5$ $\si{\kelvin})}\papertableuheadersymbole{R$ $(\si{\kilo\ohm})}\\\paperiline
...
\papersec{Analysis} 
	...
	\paperfig{thermistor-plot}{\pdf{Thermistor}}{Resistance and residuals plotted against the temperature in the thermal flask. The curve has the function \( (1.0 \pm .1) \times 10^{13}e^{T/\pars{24.7 \pm .3}} \) and an \( R^2 \) value of 0.992783. Error bars on both temperature and resistance were included but were too small to be visible.}
	...
	\paperfig{bulb-plot}{\pdf{Bulb}}{Potential and residuals plotted against current through the incandescent bulb. The curve has the function \( \pars{0.067 \pm .002} I^{\pars{1.63 \pm .01}} \) with an \( R^2 \) value of \( 0.999532 \). Error bars on the data points were included but were too small to be visible.}
