...
\papersec{Introduction}
	...
	\paperfig{setup1}{\pdf{setup1}}{The experimental setup used to measure resistance of a thermistor at varying temperatures.}
	...
	\paperfig{setup2}{\pdf{setup2}}{The experimental setup (light bulb).}
	...
	\begin{paperwhere}
		...
		\papervar{n}{universal constant}{}
	\end{paperwhere}
	
	To obtain the value of \( n \), \( \kappa \) and \( T \) were expressed in terms of \( I \) and \( V \) and further in terms of \( I \) (and constants) only with the help of the expression in (2). In particular, it was found that 
...
\papersec{Observations}
	...
	The resistance of the thermistor at various temperatures was measured and recorded. The uncertainty, as specified by the manufacturer, was $ \pm (0.2\% + 1) $ for resistances in the $ (2 \si{\kilo\ohm}, 200 \si{\kilo\ohm}) $ range. The uncertainty in temperature measurements was taken to be $ \pm 0.5 \si{\kelvin} $. \vspace{1em}
	...
	Further, current and potential for a tungsten filament light bulb were measured and recorded. As specified by the manufacturer, the uncertainty in potential measurements was taken to be \( \pm (0.25\% + 1) \); current measurements carried an uncertainty of \( \pm (1\% + 3) \). \vspace{1em}
...
\papersec{Analysis}
	...
	\paperfig{thermistor-plot}{\pdf{Thermistor}}{Resistance of the thermistor plotted against the temperature in the thermal flask, with least squares fit included in blue. Error bars on both temperature and resistance were too small to be visible. The plot of residuals indicated that the model is a better fit for greater temperatures.} \vspace{1em}
	...
	Upon obtaining the value of \( a \), the universal constant \( n \) in Stefan-Boltzmmann law could be approximated. Plugging \( a = 1.63 \pm 0.01 \) into (6) yielded \( 4.17 \pm 0.05 \), which was close the actual value of \( n = 4\). Another constant appearing in Stefan-Boltzmann law, \( \epsilon \) (emissivity of the radiating body could be determined), differs depending on the material. \( \epsilon = 1 \) corresponds to a body that is a perfect absorber and emitter of radiant energy (i.e., a \textit{black body}); \( \epsilon = 0 \) corresponds to a perfect reflector of radiant energy. 
