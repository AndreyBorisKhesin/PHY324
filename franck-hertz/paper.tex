...
\papersec{Introduction}
	...
	\paperfig{Setup}{\pdf{setup}}{Devices used in the experiment prior to wiring. The final apparatus was connected using the schematic circuit diagram further below.}
