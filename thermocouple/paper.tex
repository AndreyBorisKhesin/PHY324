...
\begin{paperabs}
	...
	In this experiment the EMF across a thermocouple was measured at a variety of temperatures to invesigate the Seebeck Effect. Plotting the obtained data on a calibration curve proved the expected linear relationship. Upon fitting the temperature differences to the potential using the least squares method, the Seebeck coefficient was determined to be \( \pars{0.0410 \pm 0.0003} \si{\milli\volt\per\kelvin} \). Further, the resistance of the thermocouple was measured to be $(1.8\pm.4)\si{\ohm}$.
...
\papersec{Introduction}
	...
	The experiment setup included a multimeter acting as a voltmeter, two thermal flasks to ensure that the temperature was kept constant and a thermometer all arranged as shown below.
